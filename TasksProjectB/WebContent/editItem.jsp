...
<!-- load the Todo Item object that's attached to this request -->
<jsp:useBean type="com.todo.model.TodoItem" id="item" scope="request" />
...
<nav class="navbar navbar-inverse">
	...
	<div class="container">
		<form action="/TasksProjectB/controller/editItemAction" method="post">
			<input type="hidden" name="id" value="<%= item.getId() %>"/>
			<label for="usr">Edit Subject:</label> 
			<input type="text" class="form-control" name="subject" value="<%= item.getSubject() %>"/> 
			<label for="usr">Edit Due Date:</label> 
			<input type="text" class="form-control" name="date" value="<%= item.getDate() %>"/>
			<br>
